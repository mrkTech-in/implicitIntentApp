...
public class MainActivity extends AppCompatActivity {
    ...
    public void openLocation(View view) {
        ...
        Uri openloc = Uri.parse("geo:0.0?q=" + loc);
    ...
    public void shareText(View view) {
        ...
        ShareCompat.IntentBuilder.from(this).setChooserTitle(R.string.share_text).setType(mimetype).setText(share).startChooser();
